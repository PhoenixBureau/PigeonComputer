...
latex_documents = [
  ('index', 'PigeonAssembler.tex', u'Pigeon Assembler Documentation',
   u'Simon Forman', 'manual'),
]
...
man_pages = [
    ('index', 'pigeonassembler', u'Pigeon Assembler Documentation',
     [u'Simon Forman'], 1)
]
...
texinfo_documents = [
  ('index', 'PigeonAssembler', u'Pigeon Assembler Documentation',
   u'Simon Forman', 'PigeonAssembler', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Pigeon Assembler'
epub_author = u'Simon Forman'
epub_publisher = u'Simon Forman'
epub_copyright = u'2012, Simon Forman'
